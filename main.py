...
The objective of the game is to manouvre a ship from one planet to another,
...
The following simplifications have been made:
   ...
   * Ships are launched vertically. Once launched, they can not be further controlled.
